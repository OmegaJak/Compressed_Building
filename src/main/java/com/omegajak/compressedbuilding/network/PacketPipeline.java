 ...
 * some code from: cpw
 * 
 * Also Many thanks to the TConstruct team, as I blatently plagiarized this from their github.
 */
...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("CompressedBuilding", this);
        registerPackets();
    }

    public void registerPackets() {
		registerPacket(PacketCompactor.class);
	}
